...
class TestFileOrganizer:
    ...
    def test_generate_standardized_name_journal(self, organizer):
        ...
        name = organizer.generate_standardized_name(
            "some_journal.md", "journals", date(2025, 12, 3)
        )
    ...
    def test_generate_standardized_name_analysis(self, organizer):
        ...
        name = organizer.generate_standardized_name(
            "1y_report.md", "analysis", date(2025, 12, 3)
        )
        assert "1Y_" in name
        
        name = organizer.generate_standardized_name(
            "3m_analysis.md", "analysis", date(2025, 12, 3)
        )
        assert "3M_" in name
...
class TestFileArchiving:
    ...
    def test_archive_old_files(self, organizer, temp_dir):
        ...
        old_timestamp = (date.today() - timedelta(days=10)).isoformat()
