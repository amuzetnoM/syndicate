...
|------|-------------|--------|
| Finalize architecture doc | `docs/ARCHITECTURE.md` | ✅ Done |
| Create plan doc | `docs/PLAN.md` | 🔄 This file |
| Add preliminary README | `README.md` | Pending |

---

## Phase 1 — Core Module Scaffold
