...
[![Version](https://img.shields.io/badge/version-3.3.1-blue.svg)](https://github.com/amuzetnoM/gold_standard/releases) [![License](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE/) [![Python](https://img.shields.io/badge/python-3.10%20|%203.11%20|%203.12%20|%203.13-blue.svg)](https://www.python.org/) [![Docker](https://img.shields.io/badge/docker-ready-2496ED.svg)](https://ghcr.io/amuzetnom/gold_standard)
...
[![Target](https://img.shields.io/badge/target-v3.4.0-blue.svg)](./) [![Priority](https://img.shields.io/badge/priority-production_hardening-critical.svg)](./)
...
* **File Organizer Stability**
  ...
  * Case-insensitive check covers all FILE\_INDEX variations
...
* Added E402 to ruff ignore list (module import order in notion\_publisher)
...
* **Prometheus Metrics Endpoint**
  ...
  * Metrics: tasks\_ready, tasks\_scheduled, stuck\_tasks, completions, failures
...
* **System Health Monitoring**
  ...
  * Real-time metrics: ready\_now, scheduled\_future, stuck\_in\_progress counts
  * 24-hour execution statistics: total, success, avg\_time\_ms
...
* **Self-Healing Recovery**
  ...
  * `retry_count` and `last_error` columns in action\_insights table
* **Documentation Overhaul**
  ...
  * index\_docs.html: New "Intelligent Scheduling" sidebar section with feature cards
...
* **Notion Sync Deduplication**
  * New `notion_sync` table tracks file\_path, file\_hash, notion\_page\_id
...
* **Comprehensive File Tagging**
  * Expanded TYPE\_PATTERNS covering all file organizer categories
  * New KEYWORD\_PATTERNS for Fed, FOMC, CPI, NFP, PCE, etc.
  * Enhanced TICKER\_PATTERNS (GOLD, SILVER, DXY, VIX, SPY, TLT, GDX, etc.)
  * DOC\_TYPE\_EMOJIS mapping for visual distinction in Notion
* **Rich Notion Formatting Enhancements**
  * Expanded SECTION\_EMOJIS (economic, institutional, research, premarket, etc.)
  * Comprehensive emoji\_map and color\_map in `_add_header_callout()`
...
## [3.1.0](https://github.com/amuzetnoM/gold_standard/compare/v3.0.0...v3.1.0) - 2025-12-03
...
* Output path resolution in notion\_publisher.py
* Removed residual frontmatter code from economic\_calendar.py
* Moved test\_init\_cortex.py to tests/ folder

***

## [3.0.0](https://github.com/amuzetnoM/gold_standard/compare/v2.1.0...v3.0.0) - 2025-12-03
...
* **Autonomous Task Execution System**
  ...
  * Six action types: research, data\_fetch, news\_scan, calculation, monitoring, code\_task
...
## [2.1.0](https://github.com/amuzetnoM/gold_standard/compare/v2.0.0...v2.1.0) - 2025-12-01
...
## [2.0.0](https://github.com/amuzetnoM/gold_standard/compare/v1.5.0...v2.0.0) - 2025-11-28
...
## [1.5.0](https://github.com/amuzetnoM/gold_standard/compare/v1.0.0...v1.5.0) - 2025-11-25
...
## [1.0.0](https://github.com/amuzetnoM/gold_standard/compare/v0.1.0...v1.0.0) - 2025-11-20

### Added

* **Core Analysis Engine**
  * Multi-asset analysis: Gold, Silver, DXY, VIX, 10Y Yield, S\&P 500
  * Technical indicators: RSI, ADX, ATR, SMA (50/200) via pandas\_ta
...
## [0.1.0](https://github.com/amuzetnoM/gold_standard/releases/tag/v0.1.0) - 2025-11-15
