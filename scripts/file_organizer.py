...
class FileOrganizer:
    ...
    def generate_standardized_name(self, original_name: str, category: str, 
                                    file_date: Optional[date] = None) -> str:
    ...
    def get_recent_files(self, category: Optional[str] = None, 
...
"""
    ...
    def run_maintenance(self, archive_days: int = None) -> Dict:
        ...
        self.logger.info(f"[ORGANIZER] Maintenance complete: {results['organized']} organized, {results['archived']} archived")
