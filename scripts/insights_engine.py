...
KNOWN_ENTITIES = {
    'institutions': [
        ...
        'BOJ', 'Bank of Japan', 'BOE', 'Bank of England', 'PBOC',
        'People\'s Bank of China', 'SNB', 'Swiss National Bank', 'RBA',
        'Reserve Bank of Australia', 'CME', 'CME Group', 'COMEX', 'LBMA',
        'World Gold Council', 'IMF', 'BIS', 'Treasury', 'US Treasury',
        'Deutsche Bank', 'Goldman Sachs', 'JP Morgan', 'JPMorgan',
        'Bank of America', 'UBS', 'Citi', 'Citigroup', 'Morgan Stanley',
        'HSBC', 'Barclays', 'Credit Suisse', 'BlackRock', 'Vanguard',
        'State Street', 'SPDR', 'GLD', 'IAU', 'SLV'
    ],
    'indicators': [
        'CPI', 'Consumer Price Index', 'PPI', 'Producer Price Index',
        'PCE', 'Core PCE', 'NFP', 'Non-Farm Payrolls', 'GDP',
        'PMI', 'ISM', 'ISM Manufacturing', 'ISM Services',
        'Unemployment Rate', 'Jobless Claims', 'Initial Claims',
        'Retail Sales', 'Industrial Production', 'Housing Starts',
        'Consumer Confidence', 'Michigan Sentiment', 'JOLTS',
        'ADP', 'Durable Goods', 'Trade Balance', 'Current Account',
        'RSI', 'ADX', 'ATR', 'MACD', 'Moving Average', 'SMA', 'EMA',
        'Bollinger Bands', 'Fibonacci', 'Volume', 'Open Interest'
    ],
    'assets': [
        'Gold', 'Silver', 'Platinum', 'Palladium', 'Copper',
        'DXY', 'Dollar Index', 'USD', 'EUR', 'JPY', 'GBP', 'CHF',
        'VIX', 'S&P 500', 'SPX', 'SPY', 'Nasdaq', 'QQQ', 'Dow', 'DJI',
        'Treasury', 'T-Bill', 'T-Note', 'T-Bond', 'TIPS',
        '10-Year', '10Y', '2-Year', '2Y', '30-Year', '30Y',
        'Crude Oil', 'WTI', 'Brent', 'Natural Gas',
        'Bitcoin', 'BTC', 'Ethereum', 'ETH', 'Crypto'
    ],
    'events': [
        'FOMC Meeting', 'Fed Meeting', 'Rate Decision', 'Rate Hike',
        'Rate Cut', 'Jackson Hole', 'Davos', 'G7', 'G20',
        'ECB Meeting', 'BOJ Meeting', 'BOE Meeting',
        'Options Expiration', 'Quad Witching', 'Triple Witching',
        'Earnings Season', 'OpEx', 'Futures Rollover',
        'Fed Speech', 'Powell Speech', 'Lagarde Speech',
        'Testimony', 'Congressional Testimony', 'Press Conference'
    ],
    'persons': [
        'Powell', 'Jerome Powell', 'Yellen', 'Janet Yellen',
        'Lagarde', 'Christine Lagarde', 'Kuroda', 'Ueda',
        'Bailey', 'Waller', 'Bostic', 'Daly', 'Mester', 'Barkin',
        'Williams', 'Bowman', 'Cook', 'Jefferson', 'Goolsbee'
    ]
}
